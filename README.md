...
[![Build Status](https://travis-ci.com/jpogorzelski/my-wedding.svg?branch=master)](https://travis-ci.com/jpogorzelski/my-wedding)
...
To optimize the MyWedding application for production, run:
